...
import { Link } from 'react-router-dom';import { useAuth } from '@/components/auth/AuthProvider';import { NuvraBadge } from '@/components/NuvraBadge';
...
const Home: React.FC = () => {  const { user } = useAuth();
    ...
    <>      <ContactUs />
      <section className="bg-indigo-50">
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:justify-between lg:px-8">
          ...
          <div className="mt-10 flex items-center gap-x-6 lg:mt-0 lg:flex-shrink-0">            {user ? (
              <Link
                to="/dashboard"
  ...
  return (
    <div className="min-h-screen bg-white">
          <Hero data={ {"cta_text": "Get Started", "headline": "Welcome to Our Service", "image_url": null, "sub": "Your journey starts here", "type": "hero"} } className="section-hero" />
          <Features data={ {"items": [{"desc": "Discover how this feature can revolutionize your workflow and boost your productivity.", "title": "Feature One"}, {"desc": "Seamlessly integrate with your existing tools and services for a cohesive experience.", "title": "Feature Two"}, {"desc": "Enjoy robust security and privacy features designed to protect your data.", "title": "Feature Three"}], "type": "features"} } className="section-features" />
          <Faq data={ {"items": [], "title": "Frequently Asked Questions", "type": "faq"} } className="section-faq" />
           {/* Custom Component: Testimonials - dynamically rendered */}
           <section className="section-custom py-12">
             <div className="mx-auto max-w-6xl px-6">
               {(() => {
                 ...
                 if (Component) {
                   return (
                    <div className={"replica-section section-testimonials"} style={ { width: "100%" } }>
                      <Component
                        {...{"data": [{"name": "User One", "testimonial": "This service changed my life!"}, {"name": "User Two", "testimonial": "I love using this service!"}], "title": "What Our Users Say"} }
                        className="replica-section section-testimonials"
                      />
                    </div>
                    );
                 }
                 return (
                   <div className="card rounded-2xl border p-8">
                     <h3 className="text-xl font-semibold">
                       Testimonials (component not found)
                     </h3>
                     <p className="mt-3">
                       { "" }
                     </p>
          ...
          <Pricing data={ {"plans": [{"cta": "Try free", "features": ["1 project", "Basic templates"], "highlight": false, "name": "Starter", "price": "$0"}, {"cta": "Upgrade", "features": ["Unlimited projects", "Versioning", "Priority builds"], "highlight": false, "name": "Pro", "price": "$29"}], "subtitle": "", "title": "Pricing", "type": "pricing"} } className="section-pricing" />
