...
import { supabase } from '@/lib/supabase';import { useAuth } from '@/components/auth/AuthProvider';import { formatAmount } from '@/lib/stripe';
...
export const InvoiceList: React.FC<InvoiceListProps> = ({
  ...
  showFilters = true,
  customerId
}) => {  const { user } = useAuth();  const [invoices, setInvoices] = useState<Invoice[]>([])
