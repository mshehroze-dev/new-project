...
import { createSubscription, redirectToCheckout, handleStripeError } from '../../lib/stripe';import { useAuth } from '../auth/AuthProvider';
...
export function CheckoutButton({ 
  ...
  const [loading, setLoading] = useState(false);  const { user } = useAuth();
